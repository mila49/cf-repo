...
from src.models import DAE, dae_loss


class DAEPipeline(EmbeddingPipeline):
    """
    Pipeline for training a Denoising Autoencoder (DAE) on single-cell data.
    """
    ...
    def setup_model(self):
        ...
        self.model = DAE(
            ...
            mask_rate=self.config.get("mask_rate", 0.3),
        ).to(self.device)
    ...
    def compute_loss(self, batch_x):
        ...
        return dae_loss(decoded, batch_x)
